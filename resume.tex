...
\section{\mysidestyle Work Experience}
	\begin{asparablank}
		...
		\small Started development on a new integrations framework/RESTful API using \textbf{Flask}, \textbf{RabbitMQ}, \textbf{Vault}, and other technologies for job dispatching and management.
