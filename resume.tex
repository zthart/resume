...
\section{\mysidestyle Projects}
	\begin{asparablank}
		...
		\small Setup and Management of a small computing cluster create for members of the Computer Science House at RIT. Allows for users to submit jobs to be run and managed using \textbf{SLURM Workload Manager}.
	\end{asparablank}
