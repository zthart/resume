...
\section{\mysidestyle Objective}
	\begin{asparablank}
    	\item Seeking a \textbf{full time position} or intership in \textbf{Software Engineering} beginning Winter 2020
        \normalsize
        \\
	\end{asparablank}
...
\section{\mysidestyle Projects}
	\begin{asparablank}
		...
		\small Setup and Management of a small computing cluster created for members of the Computer Science House at 
        RIT. Allows for users to submit jobs to be run and managed using \textbf{SLURM Workload Manager}.
		\\
